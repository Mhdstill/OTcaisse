<x-app-layout>
    <div class="m-10">
        <div class="pb-8 flex justify-start items-center">
                <a class="border-2 border-emerald-300 bg-white text-black hover:text-white hover:bg-emerald-300 p-2 ml-2" href="{{ route('categories.index') }}">
                Retour</a>
        </div>
        <div class="row mt-2 font-paragraph">
            ...
            <div class="col-lg-12 text-black drop-shadow-lg">
                @if ($errors->any())
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mt-4 pb-5">
                            ...
                            <select class="text-black" name="status">
                               ...
                               <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                <button type="submit" class="border-2 border-emerald-300 bg-white text-black hover:text-white hover:bg-emerald-300 p-3 px-5">Envoyer</button>
                            </div>
                            </div>
                        </form>
                    </div>
