<x-app-layout>
    ...
    <div class="m-10">
        <div class="pb-8 flex justify-around items-center">
            ...
            <a class="border-4 border-gray-800 bg-gray-800 text-white rounded-xl p-2" href="{{ route('categories.create') }}">
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td>
                                <form action="{{ route('categories.destroy', $category->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <a class="btn btn-info pr-2 class=font-medium text-green-600 dark:text-green-500 hover:underline" href="{{ route('categories.show', $category->id) }}">Voir</a>
                                    <a class="btn btn-primary pr-2 class=font-medium text-blue-600 dark:text-blue-500 hover:underline" href="{{ route('categories.edit', $category->id) }}">Editer</a>
